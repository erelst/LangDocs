...
window.BANK = (window.BANK || []).concat([
  {
    ...
    blocks: [
      { sp: 'A', id: 'Saya ingin meminta waktu Anda, saya laporkan dulu keadaannya sekarang.', t: ['お時間', 'を', 'いただき', 'たい', 'の', 'です', 'が', '、', '今', 'の', '状況', 'を', 'ご報告', 'します', '。'] },
      { sp: 'A', id: 'Tujuh puluh persen sudah selesai, dan sisanya hanya memeriksa angkanya.', t: ['全体', 'の', '七割', 'は', 'できて', 'いて', '、', '残り', 'は', '数字', 'の', '確認', 'だけ', 'です', '。'] },
      { sp: 'B', id: ['Sepertinya sudah cukup jauh berkembang.', 'Ada yang menghambat?'], t: ['だいぶ', '進んで', 'いる', 'よう', 'です', 'ね', '。', '何', 'か', '引っかかって', 'います', 'か', '。'] },
      { sp: 'A', id: 'Jawaban dari mitra baru datang besok, jadi sebelum itu tidak bisa saya rapikan.', t: ['取引先', 'から', 'の', '返事', 'が', '明日', 'に', 'なる', 'ので', '、', 'そこ', 'から', 'で', 'ない', 'と', '詰められ', 'ません', '。'] },
      { sp: 'B', id: ['Perlu berapa lama?', 'Kalau alasannya jelas, tidak apa-apa.'], t: ['どの', 'くらい', '必要', 'ですか', '。', '理由', 'が', 'はっきり', 'して', 'いれ', 'ば', '構い', 'ません', '。'] },
      { sp: 'A', id: ['Minta dua hari.', 'Besok lusa pagi saya periksa, dan siangnya saya serahkan.'], t: ['二日', 'ください', '。', '明後日', 'の', '午前', 'に', '確認', 'して', '、', '昼', 'まで', 'に', '出します', '。'] },
      { sp: 'B', id: ['Baik.', 'Kalau begitu, tolong selesaikan sampai besok lusa siang.'], t: ['わかり', 'ました', '。', 'では', '、', '明後日', 'の', '昼', 'まで', 'に', 'して', 'ください', '。'] },
      { sp: 'A', id: ['Terima kasih.', 'Kalau sepertinya akan terlambat, saya kabari lebih awal lagi.'], t: ['ありがとう', 'ございます', '。', '遅れ', 'そう', 'な', 'とき', 'は', 'また', '早め', 'に', '連絡', 'します', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Minggu lalu, sehari sebelum menyerahkan penawaran, saya menyadari ada satu angka yang bergeser.', t: ['先週', '、', '見積書', 'を', '出す', '前日', 'に', '、', '数字', 'が', '一つ', 'ずれて', 'いる', 'の', 'に', '気が付き', 'ました', '。'] },
      { id: 'Totalnya menjadi sekitar dua puluh ribu yen lebih besar, dan kalau langsung diserahkan, pasti jadi masalah nanti.', t: ['合計', 'が', '二万円', 'ほど', '多く', 'なって', 'いて', '、', 'そのまま', '出して', 'いれ', 'ば', '、', 'あと', 'で', '必ず', '問題', 'に', 'なって', 'いました', '。'] },
      { id: 'Saya segera melaporkannya kepada atasan, dan menjelaskan di mana salahnya.', t: ['すぐ', 'に', '上司', 'に', '報告', 'して', '、', 'どこ', 'で', '間違えた', 'の', 'か', 'を', '説明', 'しました', '。'] },
      { id: 'Berkat itu, saya bisa memperbaikinya sebelum diserahkan, dan pelanggan tidak dirugikan sama sekali.', t: ['おかげ', 'で', '、', '出す', '前', 'に', '直す', 'こと', 'が', 'でき', '、', 'お客様', 'に', 'は', '何', 'も', '迷惑', 'を', 'かけ', 'ません', 'でした', '。'] },
      { id: 'Sejak itu, saya pisahkan hari memasukkan angka dan hari menyerahkannya, dan di antaranya saya periksa sekali.', t: ['あれ', 'から', '、', '数字', 'を', '入れた', '日', 'と', '出す', '日', 'を', '分けて', '、', '間に', '一度', '見直す', 'ように', 'しました', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Pagi, begitu duduk di tempat, pertama-tama saya memeriksa apakah angka di bahannya sudah cocok.', t: ['朝', '、', '席', 'に', '着い', 'たら', '、', 'まず', '資料', 'の', '数字', 'が', '合って', 'いる', 'か', 'を', '確認', 'しました', '。'] },
      { id: 'Kalau dibiarkan seperti dibuat kemarin, angka lama masih tertinggal, jadi pagi selalu saya periksa ulang.', t: ['前', 'の', '日', 'に', '作った', 'まま', 'だ', 'と', '古い', '数字', 'が', '残る', 'ので', '、', '朝', 'に', '必ず', '見直し', 'ます', '。'] },
      { id: 'Karena ruang rapatnya sempit, saya cetak kertas sejumlah pesertanya dan menatanya lebih dulu.', t: ['会議室', 'が', '狭かった', 'ので', '、', '人数', '分', 'の', '紙', 'を', '刷って', '、', '先', 'に', '並べて', 'おき', 'ました', '。'] },
      { id: 'Mulai jam sepuluh, dan tanya jawabnya memanjang, tetapi selesai jam setengah dua belas.', t: ['十時', 'に', '始まって', '、', '質疑', 'が', '長く', 'なり', 'ました', 'が', '、', '十一時半', 'に', '終わり', 'ました', '。'] },
      { id: 'Terakhir, saya bacakan siapa mengerjakan apa sampai kapan, dan kami samakan di tempat itu juga.', t: ['最後', 'に', '、', '誰', 'が', '何', 'を', 'いつ', 'まで', 'に', 'やる', 'の', 'か', 'を', '読み上げて', '、', 'その場', 'で', '共有', 'しました', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Tepat waktu saya bersiap pulang, datang pekerjaan yang mendesak.', t: ['帰る', '準備', 'を', 'して', 'いる', 'ところ', 'に', '、', '急ぎ', 'の', '仕事', 'が', '来る', 'ん', 'だ', 'よ', '。'] },
      { id: 'Setiap kali dikatakan hanya hari ini, dan itu sudah berlangsung dua minggu.', t: ['毎回', '「', '今日', 'だけ', '」', 'と', '言われて', '、', 'それ', 'が', '二週間', '続いて', 'いる', '。'] },
      { id: 'Bahkan, lebih banyak yang sebenarnya bisa dikerjakan besok pagi dengan hasil yang sama.', t: ['しかも', '、', '明日', 'の', '朝', 'に', 'やれ', 'ば', '同じ', 'こと', 'が', 'できる', 'こと', 'の', '方', 'が', '多い', '。'] },
      { id: 'Begitu saya sadar, saya tidak ingat lagi kapan terakhir pulang ke rumah waktu masih terang.', t: ['気が付い', 'たら', '、', '明るい', 'うち', 'に', '家', 'に', '帰った', 'の', 'が', 'いつ', 'だ', 'か', '思い出せ', 'ない', '。'] },
      { id: 'Bukannya mau berhenti, saya hanya ingin pulang lebih cepat saja.', t: ['辞め', 'たい', 'わけ', 'じゃ', 'なくて', '、', 'ただ', '早く', '帰り', 'たい', 'だけ', 'な', 'ん', 'だ', 'けど', 'ね', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Dari penjelasan tadi, ada dua hal yang ingin saya pastikan.', t: ['今', 'の', 'お話', 'で', '、', '二つ', 'だけ', '確認', 'させて', 'ください', '。'] },
      { id: ['Yang pertama tenggatnya.', 'Saya tidak tahu harus diserahkan paling lambat kapan.'], t: ['一つ', 'は', '締め切り', 'です', '。', 'いつまで', 'に', '出せ', 'ば', 'いい', 'の', 'か', 'が', '分かり', 'ません', '。'] },
      { id: ['Yang satu lagi, siapa yang memutuskan di akhir.', 'Kalau tahu siapa yang harus saya konfirmasi, saya lebih mudah bekerja.'], t: ['もう', '一つ', 'は', '、', '最後', 'に', '決める', 'の', 'が', '誰', 'な', 'の', 'か', 'です', '。', '確認', 'する', '相手', 'が', '分かる', 'と', '進め', 'やすい', 'ので', '。'] },
      { id: 'Kalau dua hal ini jelas, hari ini juga saya sudah bisa mulai.', t: ['この', '二つ', 'が', '決まれ', 'ば', '、', '今日', 'の', 'うち', 'に', '手', 'を', '付け', 'られ', 'ます', '。'] },
      { id: 'Kalau dikerjakan tanpa jelas, nanti harus diulang, dan itu yang paling menyulitkan.', t: ['分から', 'ない', 'まま', '進める', 'と', '、', 'あと', 'で', 'やり直す', 'こと', 'に', 'なる', 'の', 'が', '一番', '困り', 'ます', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: ['Kalau ada masalah, katakan selagi masih bisa diperbaiki.', 'Kalau baru dikatakan setelah selesai, tidak ada lagi pilihan yang tersisa.'], t: ['問題', 'が', 'あっ', 'たら', '、', '直せ', 'る', 'うち', 'に', '言って', 'ください', '。', '終わって', 'から', '言って', 'も', '、', '選べる', '道', 'が', '残り', 'ません', '。'] },
      { id: ['Laporan itu menulis dampaknya lebih dulu daripada penyebabnya.', 'Karena kalau tahu apa yang berhenti, saya bisa memberi arahan.'], t: ['報告', 'は', '、', '原因', 'より', '先', 'に', '影響', 'を', '書きます', '。', '何', 'が', '止まって', 'いる', 'の', 'か', 'が', '分かれ', 'ば', '、', '指示', 'が', '出せ', 'る', 'から', 'です', '。'] },
      { id: ['Bilang belum tahu pun tidak apa-apa.', 'Bukan tidak mengetahuinya yang jadi masalah, tetapi diam saja.'], t: ['「', 'まだ', '分かり', 'ません', '」', 'で', 'も', '構い', 'ません', '。', '分から', 'ない', 'こと', '自体', 'より', '、', '黙って', 'いる', '方', 'が', '問題', 'です', '。'] },
      { id: ['Begitu penyebabnya ketahuan, hubungi sekali lagi.', 'Laporan pertama cukup sampai di situ.'], t: ['原因', 'が', '分かった', '時点', 'で', '、', '二回目', 'の', '連絡', 'を', 'して', 'ください', '。', '最初', 'の', '報告', 'は', 'それ', 'で', '終わり', 'です', '。'] },
      { id: ['Yang penting, kabar buruk justru semakin cepat disampaikan.', 'Orang yang bisa begitu semakin dipercaya pekerjaan.'], t: ['大事', 'な', 'の', 'は', '、', '悪い', '知らせ', 'ほど', '早く', '出す', 'こと', 'です', '。', 'それが', 'できる', '人', 'ほど', '、', '任される', '仕事', 'が', '増え', 'ます', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: ['Ini laporan rapat tadi.', 'Saya ringkas supaya bisa dibaca dalam sepuluh menit.'], t: ['先ほど', 'の', '打ち合わせ', 'の', 'ご報告', 'です', '。', '十分', 'で', '読める', 'ように', 'まとめ', 'ました', '。'] },
      { id: ['Yang sudah diputuskan ada dua.', 'Tenggatnya tanggal lima belas bulan depan, dan penanggung jawabnya tim satu.'], t: ['決まった', 'の', 'は', '二つ', 'です', '。', '納期', 'は', '来月', 'の', '十五日', '、', '担当', 'は', '第一', 'チーム', 'に', 'なり', 'ました', '。'] },
      { id: ['Yang belum diputuskan adalah anggarannya.', 'Ini dipindah ke rapat minggu depan.'], t: ['まだ', '決まって', 'い', 'ない', 'の', 'は', '予算', 'です', '。', 'これは', '来週', 'の', '会議', 'に', '回す', 'こと', 'に', 'なり', 'ました', '。'] },
      { id: 'Yang bukan keputusan tetapi harus diajukan rancangannya sebelum pertemuan berikutnya ada tiga.', t: ['決定', 'では', 'ない', 'けど', '、', '次回', 'まで', 'に', '案', 'を', '出す', 'こと', 'に', 'なった', '物', 'が', '三つ', 'あります', '。'] },
      { id: ['Yang perlu ikut tahu adalah bagian keuangan dan pelanggan.', 'Saya sendiri yang menghubungi hari ini.'], t: ['共有', 'が', '必要', 'な', 'の', 'は', '経理', 'と', 'お客様', 'です', '。', '私', 'から', '今日', 'の', 'うち', 'に', '連絡', 'します', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Jumat siang, saya ingin pulang jam tiga, apakah boleh?', t: ['金曜', 'の', '午後', '、', '三時', 'に', '上がらせて', 'いただき', 'たい', 'の', 'です', 'が', '、', 'よろしい', 'でしょうか', '。'] },
      { id: 'Ada urusan rumah yang hanya bisa saya yang mengerjakan.', t: ['家', 'の', '用事', 'で', '、', '私', 'で', 'ない', 'と', 'できない', 'こと', 'な', 'の', 'です', '。'] },
      { id: 'Bahan yang sedang saya kerjakan selesai pagi, jadi untuk hari Jumat tidak ada masalah.', t: ['今', 'かかって', 'いる', '資料', 'は', '午前', 'で', '終わる', 'ので', '、', '金曜', 'の', '分', 'は', '問題', 'あり', 'ません', '。'] },
      { id: ['Kalau ada kabar mendesak, saya angkat teleponnya.', 'Isinya masih bisa saya balas dari rumah.'], t: ['急ぎ', 'の', '連絡', 'が', '来た', '場合', 'は', '、', '携帯', 'に', '出', 'ます', '。', '家', 'から', 'で', 'も', '返せる', '内容', 'です', '。'] },
      { id: 'Kalau itu sulit, saya bisa pindah ke hari lain, jadi tolong beri tahu.', t: ['もし', '難しけれ', 'ば', '、', '別の', '日', 'に', '変え', 'ます', 'ので', '、', '教えて', 'ください', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Membawa pulang pekerjaan di dalam tas setiap hari sebaiknya dihentikan dulu.', t: ['毎日', '鞄', 'に', '入れて', '帰る', 'の', 'は', '、', '一度', 'やめた', '方', 'が', 'いい', 'よ', '。'] },
      { id: 'Barang yang dibawa pulang itu hampir tidak pernah dibuka, dan pagi berikutnya sudah jadi besok lagi.', t: ['家', 'に', '持って', '帰った', '物', 'って', '、', 'ほとんど', '開け', 'ない', 'まま', '次の', '朝', 'に', 'なる', 'ん', 'だ', '。'] },
      { id: 'Daripada begitu, menyelesaikan satu hal saja sebelum pulang membuat hari berikutnya lebih ringan.', t: ['それ', 'より', '、', '帰る', '前', 'に', '一個', 'だけ', '終わらせる', '方', 'が', '、', '次の', '日', 'が', '楽', 'に', 'なる', '。'] },
      { id: 'Karena begitu kita putuskan membawanya pulang, kita merasa hari ini belum selesai, dan tidak bisa beristirahat.', t: ['持って', '帰る', 'と', '決めた', '時点', 'で', '、', '今日', 'は', 'もう', '終わって', 'い', 'ない', 'と', '思って', 'しまう', 'から', '、', '休め', 'なく', 'なる', '。'] },
      { id: 'Kalau memang masih ada sisa, cukup tulis memo besok pagi mau mulai dari mana, lalu tutup saja.', t: ['どうしても', '残る', 'なら', '、', '明日', 'の', '朝', 'に', '何', 'から', 'やる', 'か', 'だけ', 'メモ', 'して', '、', 'それ', 'で', '閉じる', 'と', 'いい', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Bulan depan, dari tanggal delapan sampai tanggal sepuluh, saya ingin mengambil cuti tiga hari.', t: ['来月', 'の', '八日', 'から', '十日', 'まで', '、', '三日', '間', 'お休み', 'を', 'いただき', 'たい', 'の', 'です', 'が', '。'] },
      { id: 'Untuk hal mendesak selama itu, saya sudah meminta bantuan Tanaka dari tim yang sama.', t: ['その', '間', 'の', '急ぎ', 'の', '件', 'は', '、', '同じ', 'チーム', 'の', '田中', 'さん', 'に', 'お願い', 'して', 'あります', '。'] },
      { id: 'Dokumen serah terimanya saya buat sampai hari Jumat minggu ini.', t: ['引き継ぎ', 'の', '書類', 'は', '今週', 'の', '金曜', 'まで', 'に', '作り', 'ます', '。'] },
      { id: 'Saya berniat menyelesaikan semua bagian saya sebelum hari terakhir saya masuk.', t: ['休む', '前', 'の', '日', 'まで', 'に', '、', '自分', 'の', '担当', '分', 'は', '全部', '終わらせる', 'つもり', 'です', '。'] },
      { id: 'Kalau tanggalnya sulit, saya bisa menggeser ke minggu lain, jadi tolong kabari.', t: ['もし', '日程', 'が', '難しい', 'よう', 'でしたら', '、', '別の', '週', 'に', 'ずらします', 'ので', '、', 'お知らせ', 'ください', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Pada tahun kedua saya masuk kerja, saya pertama kali diminta menjelaskan di rapat besar.', t: ['入社', 'して', '二年目', 'の', 'とき', '、', '初めて', '大きい', '会議', 'で', '説明', 'する', 'こと', 'に', 'なりました', '。'] },
      { id: 'Sehari sebelumnya saya hanya membacanya sekali, dan tidak mengukur waktunya.', t: ['前の', '日', 'に', '一度', '読んだ', 'だけ', 'で', '、', '時間', 'を', '計って', 'は', 'い', 'ません', 'でした', '。'] },
      { id: 'Tiga menit setelah mulai bicara, saya sadar hanya separuh bahan yang bisa saya pakai.', t: ['話し', '始めて', '三分', 'で', '、', '用意', 'した', '内容', 'の', '半分', 'しか', '使え', 'ない', 'と', '気が付き', 'ました', '。'] },
      { id: 'Akhirnya, lima menit terakhir jadi serba cepat, dan angka yang paling ingin saya sampaikan malah terlewat.', t: ['結局', '、', '最後', 'の', '五分', 'で', '駆け足', 'に', 'なり', '、', '一番', '言い', 'たかった', '数字', 'を', '飛ばして', 'しまいました', '。'] },
      { id: 'Sejak itu, saya selalu berlatih sambil melihat jam, dan bagian yang tidak masuk saya potong lebih dulu.', t: ['それ', 'から', 'は', '、', '必ず', '時計', 'を', '見ながら', '練習', 'して', '、', '入らない', '部分', 'は', '先', 'に', '削る', 'ように', 'して', 'います', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: ['Ada pengumuman untuk seluruh tim.', 'Mulai bulan depan jam kerja berubah.'], t: ['チーム', 'の', '皆さん', 'に', 'お知らせ', 'です', '。', '来月', 'から', '勤務', 'の', '時間', 'が', '変わります', '。'] },
      { id: 'Jam masuknya dari sembilan menjadi setengah sepuluh, dan jam pulangnya tetap jam enam.', t: ['始業', 'が', '九時', 'から', '九時半', 'に', 'なり', '、', '終業', 'は', '六時', 'の', 'まま', 'です', '。'] },
      { id: 'Selain itu, kerja lembur setelah jam pulang sekarang memerlukan pengajuan terlebih dahulu.', t: ['また', '、', '終業', '後', 'の', '残業', 'は', '、', '事前', 'に', '申請', 'が', '必要', 'に', 'なりました', '。'] },
      { id: 'Hanya untuk hal mendesak, pengajuan keesokan paginya masih diterima.', t: ['急ぎ', 'の', '場合', 'だけ', '、', '翌日', 'の', '朝', 'に', '出して', 'も', '認め', 'ます', '。'] },
      { id: 'Untuk urusan cuti, seperti sebelumnya silakan kepada atasan langsung.', t: ['休み', 'の', '相談', 'は', '、', 'これまで', 'どおり', '直属', 'の', '上司', 'に', 'お願い', 'します', '。'] },
    ]
  },
]);
