...
window.BANK = (window.BANK || []).concat([
  {
    ...
    blocks: [
      { sp: 'A', id: ['Hari ini mau ke mana?', 'Toko di depan stasiun memang murah, tetapi pasti penuh.'], t: ['今日', '、', 'どこ', 'に', 'する', '？', '駅前', 'の', '店', 'は', '安い', 'けど', '、', '絶対', '混んで', 'いる', 'よ', '。'] },
      { sp: 'B', id: ['Aku lebih suka yang tenang.', 'Soalnya aku ingin bicara santai, sudah lama tidak.'], t: ['私', 'は', '静か', 'な', '方', 'が', 'いい', 'な', '。', '久しぶり', 'に', 'ゆっくり', '話し', 'たい', 'から', '。'] },
      { sp: 'A', id: ['Kalau begitu, toko yang agak jalan kaki bagaimana?', 'Memang mahal, tetapi tempat duduknya luas.'], t: ['じゃあ', '、', '少し', '歩いた', 'ところ', 'の', '店', 'は', 'どう', '？', '高い', 'けど', '、', '席', 'が', '広い', 'よ', '。'] },
      { sp: 'B', id: ['Mahalnya berapa?', 'Anggaranku sekitar tiga ribu yen.'], t: ['どの', 'くらい', '高い', 'の', '？', '予算', 'は', '三千円', 'くらい', 'なん', 'だけど', '。'] },
      { sp: 'A', id: ['Sekitar dua ribu lima ratus yen, jadi sepertinya masih aman.', 'Mau aku pesan dulu?'], t: ['二千五百円', 'ぐらい', 'だ', 'から', '、', '大丈夫', 'だ', 'と', '思う', '。', '予約', 'して', 'おこう', 'か', '。'] },
      { sp: 'B', id: ['Kalau kamu mau begitu, sangat membantu.', 'Bertemu di stasiun jam setengah tujuh, ya?'], t: ['そう', 'して', 'くれる', 'と', '助かる', '。', '六時半', 'に', '駅', 'で', '待ち合わせ', 'で', 'いい', '？'] },
      { sp: 'A', id: ['Ya, itu sudah pasti.', 'Aku berangkat dulu dan memesan tempatnya.'], t: ['うん', '、', 'それ', 'で', '決まり', '。', '先', 'に', '行って', '席', 'を', '取って', 'おく', 'ね', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Sabtu rencananya jalan-jalan di taman dengan teman, tetapi sejak pagi hujan turun.', t: ['土曜', 'に', '友達', 'と', '公園', 'を', '歩く', '予定', 'だった', 'の', 'です', 'が', '、', '朝', 'から', '雨', 'が', '降り', 'ました', '。'] },
      { id: 'Karena tahu tidak mungkin di luar, kami putuskan mengubah rencananya saat itu juga.', t: ['外', 'は', '無理', 'だ', 'と', '分かった', 'ので', '、', 'その場', 'で', '予定', 'を', '変える', 'こと', 'に', 'しました', '。'] },
      { id: 'Kami menelepon bioskop di dekat situ dan meminta memastikan apakah masih ada tempat.', t: ['近く', 'の', '映画館', 'に', '電話', 'して', '、', '空いて', 'いる', 'か', '確認', 'して', 'もらい', 'ました', '。'] },
      { id: 'Akhirnya kami menonton film, lalu pulang setelah makan sesuatu yang hangat.', t: ['結局', '、', '映画', 'を', '見て', '、', 'その', 'あと', 'で', '温かい', '物', 'を', '食べて', '帰り', 'ました', '。'] },
      { id: 'Sayang memang tidak jadi berjalan, tetapi saya jadi tahu satu cara melewati hari hujan.', t: ['歩け', 'なかった', 'の', 'は', '残念', 'でした', 'が', '、', '雨', 'の', '日', 'の', '過ごし方', 'を', '一つ', '覚え', 'ました', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Waktu bertemu di gerbang stasiun jam enam, semua sudah lengkap.', t: ['六時', 'に', '駅', 'の', '改札', 'で', '待ち合わせ', 'たら', '、', '全員', 'そろって', 'いました', '。'] },
      { id: 'Kami makan dulu, lalu mencari tempat yang bisa dipakai bicara santai.', t: ['先', 'に', '食事', 'を', 'して', '、', 'その', 'あと', 'で', 'ゆっくり', '話せる', '場所', 'を', '探し', 'ました', '。'] },
      { id: 'Karena tokonya penuh, kami jalan sedikit dan masuk ke tempat kedua.', t: ['店', 'が', '混んで', 'いた', 'ので', '、', '少し', '歩いて', '、', '二軒目', 'に', '入り', 'ました', '。'] },
      { id: 'Begitu saya sadar, sudah lewat jam sebelas, dan waktu kereta terakhir semakin dekat.', t: ['気が付い', 'たら', '十一時', 'を', '過ぎて', 'いて', '、', '終電', 'の', '時間', 'が', '近く', 'なって', 'いました', '。'] },
      { id: 'Kami berjalan bersama sampai stasiun, dan karena peronnya berbeda, di situ kami berpisah.', t: ['駅', 'まで', '一緒', 'に', '歩いて', '、', 'ホーム', 'が', '違う', 'ので', '、', 'そこで', '別れ', 'ました', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Dia itu, selalu terlambat dua puluh menit di tempat janjian.', t: ['あの', '子', '、', 'いつも', '待ち合わせ', 'に', '二十分', '遅れて', 'くる', 'んだ', 'よ', '。'] },
      { id: 'Kalau terlambat, seharusnya dia kabari, tetapi dia datang tanpa bilang apa-apa.', t: ['遅れる', 'なら', '連絡', 'して', 'くれれ', 'ば', 'いい', 'のに', '、', '何', 'も', '言わ', 'ない', 'まま', '来る', '。'] },
      { id: 'Minggu lalu pun saya berdiri menunggu tiga puluh menit di depan stasiun sambil kedinginan.', t: ['先週', 'も', '、', '寒い', '中', 'を', '駅', 'の', '前', 'で', '三十分', '立って', '待って', 'いた', '。'] },
      { id: 'Saya pernah menegurnya sekali, tetapi hanya hari itu dia berubah, lalu kembali lagi.', t: ['一度', 'だけ', '注意', 'した', 'こと', 'は', 'ある', 'けど', '、', 'その', '日', 'だけ', '直って', '、', 'また', '元', 'に', '戻った', '。'] },
      { id: 'Mungkin sebaiknya saya menjauh, tetapi selain soal itu dia orang yang baik.', t: ['縁', 'を', '切れ', 'ば', 'いい', 'の', 'か', 'も', 'しれ', 'ない', 'けど', '、', 'それ', '以外', 'は', 'いい', '子', 'な', 'ん', 'だ', 'よ', 'ね', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Maaf, saya ingin menanyakan soal reservasinya.', t: ['すみません', '、', '予約', 'の', 'こと', 'で', 'お尋ね', 'したい', 'の', 'です', 'が', '。'] },
      { id: 'Saya menelepon seminggu lalu, dan memesan untuk empat orang jam delapan.', t: ['一週間', '前', 'に', '電話', 'して', '、', '八時', 'に', '四人', 'で', 'お願い', 'した', 'はず', 'です', '。'] },
      { id: 'Sekarang setelah nama saya dicari, ternyata tidak ada catatannya.', t: ['今', '、', '名前', 'を', '調べて', 'もらった', 'ところ', '、', '記録', 'が', '残って', 'い', 'ません', 'でした', '。'] },
      { id: 'Meja lain pun tidak apa-apa, apakah ada tempat untuk empat orang?', t: ['別', 'の', '席', 'で', 'も', 'いい', 'ので', '、', '四人', 'が', '座れる', '場所', 'は', 'あり', 'ません', 'か', '。'] },
      { id: 'Kalau sulit, tolong beri tahu lebih awal, apakah saya menunggu atau menyerah.', t: ['難しけれ', 'ば', '、', '待つ', 'の', 'か', '諦める', 'の', 'か', '、', '早め', 'に', '教えて', 'ください', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: ['Pertama, tidak perlu membeli alat apa pun.', 'Perlengkapan di ruang kelas dipinjamkan.'], t: ['まず', '、', '道具', 'を', '買う', '必要', 'は', 'あり', 'ません', '。', '教室', 'の', '物', 'を', '貸し', 'ます', '。'] },
      { id: 'Yang baru pertama ikut bisa mencoba sekali, jadi putuskan setelah itu apakah mau lanjut.', t: ['初めて', 'の', '方', 'は', '、', '一度', '体験', 'できる', 'の', 'で', '、', 'それ', 'で', '続ける', 'か', '決めて', 'ください', '。'] },
      { id: ['Soal pakaian, yang penting jangan takut kotor.', 'Lebih baik lagi kalau berlengan.'], t: ['服装', 'は', '、', '汚れて', 'も', 'いい', '物', 'が', '安心', 'です', '。', '袖', 'の', 'ある', '服', 'だ', 'と', 'なお', 'いい', 'です', '。'] },
      { id: 'Yang sudah punya perlengkapannya sendiri, silakan membawanya, tidak apa-apa.', t: ['道具', 'を', '持って', 'いる', '方', 'は', '、', '持って', '来て', 'いただい', 'て', 'も', '構い', 'ません', '。'] },
      { id: 'Pendaftarannya cukup dengan mengisi formulir di resepsionis pada hari itu.', t: ['申し込み', 'は', '、', '当日', 'に', '受付', 'で', '書いて', 'いただけ', 'ば', '済み', 'ます', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: ['Aku baru pulang.', 'Orangnya lebih banyak dari dugaan, jadi aku mengantre dua puluh menit di pintu masuk.'], t: ['今', '、', '帰って', 'きた', 'よ', '。', '思って', 'いた', 'より', '人が', '多くて', '、', '入口', 'で', '二十分', '並んだ', '。'] },
      { id: 'Bagian awalnya menyenangkan, tetapi bagian akhir hanya berdiri, sampai kakiku sakit.', t: ['前半', 'は', '楽しかった', 'けど', '、', '後半', 'は', '立って', 'いる', 'だけ', 'で', '、', '足', 'が', '痛く', 'なった', '。'] },
      { id: 'Karena aku keluar sekali untuk beristirahat di luar, acaranya bisa kujalani sampai akhir.', t: ['途中', 'で', '一度', '抜けて', '、', '外', 'で', '休んだ', 'から', '、', '何と', 'か', '最後', 'まで', 'い', 'た', '。'] },
      { id: 'Pulangnya ada kereta tambahan, dan walau begitu masih perlu satu jam.', t: ['帰り', 'は', '臨時', 'の', '電車', 'が', '出て', 'いて', '、', 'それ', 'でも', '一時間', 'かかった', '。'] },
      { id: 'Secara keseluruhan bagus juga sudah pergi, tetapi lain kali aku mau mengambil tempat duduk.', t: ['全体', 'として', 'は', '行って', 'よかった', 'けど', '、', '次', 'は', '座れる', '席', 'を', '取る', 'つもり', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: ['Untuk hari Sabtu, mari siapkan dua pilihan.', 'Lebih aman memutuskan menurut cuacanya.'], t: ['土曜日', 'は', '二つ', '用意', 'して', 'おこう', '。', '天気', 'で', '決める', 'の', 'が', '安全', 'だ', 'から', '。'] },
      { id: 'Kalau cerah, sejak pagi pergi ke laut, dan makan siang di sana.', t: ['晴れ', 'たら', '、', '朝', 'から', '海', 'まで', '行って', '、', '昼', 'は', '向こう', 'で', '食べる', '。'] },
      { id: 'Kalau hujan, pilih bioskop dekat stasiun, dan makan malam di rumah.', t: ['雨', 'なら', '、', '駅', 'の', '近く', 'の', '映画館', 'に', 'して', '、', '夜', 'は', '家', 'で', '食べる', '。'] },
      { id: 'Mana yang dipilih, mari kita putuskan Jumat malam dengan melihat ramalan cuaca.', t: ['どちら', 'に', 'する', 'か', 'は', '、', '金曜', 'の', '夜', 'に', '天気予報', 'を', '見て', '決め', 'よう', '。'] },
      { id: 'Saya yang menghubungi hari Jumat, jadi sampai itu jangan isi rencana lain, ya.', t: ['私', 'が', '金曜', 'に', '連絡', 'する', 'から', '、', 'それ', 'まで', '予定', 'を', '入れ', 'ない', 'で', 'ね', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Waktu mengajak orang yang baru pertama, sebaiknya sampaikan dulu jumlah orang dan jam selesainya.', t: ['初めて', 'の', '人', 'を', '誘う', 'とき', 'は', '、', '人数', 'と', '終わる', '時間', 'を', '先', 'に', '伝えた', '方', 'が', 'いい', 'よ', '。'] },
      { id: 'Orang menolak itu bukan karena tidak suka, tetapi karena tidak tahu acaranya seperti apa.', t: ['断る', 'の', 'は', '、', '嫌', 'だ', 'から', 'で', 'は', 'なく', 'て', '、', 'どんな', '場', 'か', '分から', 'ない', 'から', 'な', 'ん', 'だ', '。'] },
      { id: 'Kalau dikatakan berapa orang dan sampai kira-kira jam berapa, orang bisa memutuskan dengan tenang.', t: ['「', '何人', 'で', '、', '何時', 'ごろ', 'まで', '」', 'と', '言え', 'ば', '、', '安心', 'して', '決め', 'られる', '。'] },
      { id: 'Kalau ternyata masih ragu, sebaiknya sampaikan bahwa pulang di tengah pun tidak apa-apa.', t: ['それ', 'でも', '迷って', 'いる', 'よう', 'なら', '、', '途中', 'で', '帰って', 'も', 'いい', 'と', '伝える', 'と', 'いい', '。'] },
      { id: 'Kalau sudah datang sekali, lain kali jadi lebih mudah mengajaknya lagi.', t: ['一度', '来て', 'くれれ', 'ば', '、', '次', 'から', 'は', '声', 'を', 'かけ', 'やすく', 'なる', 'から', 'ね', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Maaf, ada satu permintaan, boleh?', t: ['ごめん', '、', '一つ', 'お願い', 'が', 'ある', 'ん', 'だ', 'けど', 'いい', 'かな', '。'] },
      { id: 'Besok pagi tiba-tiba ada urusan, jadi saya tidak bisa tepat jam enam.', t: ['明日', 'の', '朝', '、', '急', 'に', '用事', 'が', '入って', 'しまって', '、', '六時', 'に', '間に合わ', 'ない', 'んだ', '。'] },
      { id: 'Bisakah digeser ke jam tujuh?', t: ['七時', 'に', 'ずらして', 'もらう', 'こと', 'は', 'でき', 'ない', 'かな', '。'] },
      { id: 'Kalau jam tujuh terlalu telat, bertemu di dekat rumah saya juga tidak apa-apa.', t: ['もし', '七時', 'が', '遅い', 'なら', '、', '私', 'の', '家', 'の', '近く', 'で', '会う', 'の', 'で', 'も', 'いい', 'よ', '。'] },
      { id: 'Mana yang lebih baik, akan membantu kalau diberi tahu sebelum sore.', t: ['どちら', 'が', 'いい', 'か', '、', '夕方', 'まで', 'に', '教えて', 'くれる', 'と', '助かる', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Tahun lalu, saya pernah masuk klub hobi sendirian.', t: ['去年', '、', '趣味', 'の', 'クラブ', 'に', '一人', 'で', '入った', 'こと', 'が', 'あります', '。'] },
      { id: 'Hari pertama tidak ada satu pun orang yang saya kenal, dan saya berdiri sekitar sepuluh menit di pintu masuk.', t: ['初日', 'は', '知って', 'いる', '人', 'が', '一人', 'も', 'い', 'なくて', '、', '入口', 'で', '十分', 'くらい', '立って', 'いました', '。'] },
      { id: 'Lalu datang orang yang lebih tua, dan dia memberi tahu tempat alat-alatnya.', t: ['そこ', 'へ', '年上', 'の', '人', 'が', '来て', '、', '道具', 'の', '場所', 'を', '教えて', 'くれた', 'の', 'です', '。'] },
      { id: 'Hanya dengan itu perasaan saya jadi ringan, dan hari itu saya bisa bicara dengan lima orang.', t: ['それ', 'だけ', 'で', '気持ち', 'が', '楽', 'に', 'なって', '、', 'その', '日', 'の', 'うち', 'に', '五人', 'と', '話せ', 'ました', '。'] },
      { id: 'Sejak itu, kepada orang yang baru datang, saya yang lebih dulu menyapa.', t: ['あれ', 'から', '、', '新しく', '来た', '人', 'に', 'は', '私', 'から', '声', 'を', 'かける', 'ように', 'して', 'います', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: ['Ada pengumuman untuk semuanya.', 'Ada dua perubahan untuk pertemuan bulan ini.'], t: ['皆さん', 'に', 'お知らせ', 'です', '。', '今月', 'の', '集まり', 'について', '二つ', '変更', 'が', 'あります', '。'] },
      { id: ['Pertama, jadwalnya menjadi satu minggu lebih awal.', 'Alasannya karena tempatnya bisa didapat.'], t: ['まず', '、', '予定', 'より', '一週間', '早く', 'なり', 'ました', '。', '理由', 'は', '会場', 'が', '取れ', 'た', 'から', 'です', '。'] },
      { id: ['Selanjutnya, tempatnya berubah.', 'Lebih luas dari ruangan sebelumnya, jadi perlengkapannya bisa digelar lebar.'], t: ['次に', '、', '場所', 'が', '変わり', 'ます', '。', '前', 'の', '部屋', 'より', '広い', 'の', 'で', '、', '道具', 'を', '広げ', 'られ', 'ます', '。'] },
      { id: 'Yang akan ikut, termasuk yang belum, silakan menulis nama di daftar hadir.', t: ['参加', 'する', '人', 'は', '、', 'まだ', 'の', '人', 'も', '、', '名簿', 'に', '名前', 'を', '書いて', 'ください', '。'] },
      { id: ['Batasnya tiga hari sebelumnya.', 'Setelah itu, ada kemungkinan tempatnya tidak bisa disiapkan.'], t: ['締め切り', 'は', '三日', '前', 'です', '。', 'それ', '以降', 'は', '席', 'を', '用意', 'でき', 'ない', 'こと', 'が', 'あります', '。'] },
    ]
  },
]);
