...
window.BANK = (window.BANK || []).concat([
  ...
  },
  {
    ...
    judul: 'Melaporkan dari jalan bahwa akan terlambat', judulEn: 'Reporting from the road that I will be late',
    rel: 'klien',
    sit: 'Menelepon dari perjalanan untuk melaporkan keterlambatan', sitEn: 'Calling from the road to report being late',
    id: 'Saya melaporkan bahwa kereta berhenti, perkiraan tiba lima belas menit lebih lambat, dan menawarkan memulai tanpa saya.',
    en: 'I report that the train has stopped, that I expect to arrive fifteen minutes late, and offer that they start without me.',
    note: 'Laporan dari jalan berguna karena menyebut perkiraan waktunya, bukan hanya kabar bahwa terlambat.',
    noteEn: 'A report from the road is useful because it gives an estimate, not merely the news of being late.',
    blocks: [
      { t: ['お世話に', 'なって', 'おります', '。', '今', '、', '電車', 'の', '中', 'から', 'お電話', 'して', 'います', '。'] },
      { t: ['この', '先', 'で', '点検', 'が', 'あり', '、', '十分', 'ほど', '止まって', 'います', '。'] },
      { t: ['その', 'ため', '、', '伺う', 'の', 'が', '十五分', 'ほど', '遅れ', 'ます', '。'] },
      { t: ['お待ち', 'いただく', 'の', 'は', '申し訳', 'ない', 'ので', '、', '先', 'に', '始めて', 'ください', '。'] },
      { t: ['着き', '次第', '、', 'すぐ', 'に', 'ご連絡', 'します', '。'] },
    ]
  },
  {
