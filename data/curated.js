...
window.CURATED = [
  {
    ...
    blocks: [
      { id: 'Kemarin saya makan bersama teman di restoran murah dekat stasiun, dan ternyata sangat enak.', en: 'Yesterday I ate with a friend at a cheap restaurant near the station, and it turned out to be really good.', t: ['昨日、', '駅', 'の', '近く', '安い', 'レストラン', 'で', '友達', 'と', '一緒に', 'ご飯', 'を', '食べた', 'ん', 'だけど、', 'とても', 'おいしかった', 'です。'] },
      { id: 'Tokonya kecil dan hanya ada meja panjang, dan padahal sudah lewat jam satu siang, tiga kelompok ikut mengantre.', en: 'The place was small with only a long counter, and even though it was past one in the afternoon, three groups were queued up as well.', t: ['店', 'は', 'カウンター', 'だけ', 'の', '小さな', '所', 'で、', '十三時', 'を', '過ぎて', 'いた', 'のに、', '三組', 'も', '並んで', 'いました。'] },
      { id: 'Karena menu hariannya di bawah seribu yen, saya coba memesan, tetapi porsinya lebih banyak dari dugaan, jadi saya dan teman bertukar setengah.', en: 'Since the daily special was under a thousand yen, I tried ordering it, but the portion was bigger than I expected, so my friend and I swapped half of ours.', t: ['日替わり', 'が', '千円', '以下', 'だった', 'ので', '頼んで', 'みた', 'のですが、', '思った', 'より', '量', 'が', '多く、', '友達', 'と', '半分', 'ずつ', '交換', 'しました。'] },
      { id: 'Lain kali saya mau pergi saat sepi, dan akhir pekan ini saya ingin makan di sana sekali lagi.', en: 'Next time I want to go when it is quiet, and this weekend I want to eat there once more.', t: ['今度', 'は', '空いて', 'いる', '時間', 'に', '行って、', '今週末', 'もう', '一度', '食べ', 'に', '行きたい', 'と', '思って', 'います。'] }
    ]
  }
];
