...
window.BANK = (window.BANK || []).concat([
  {
    ...
    blocks: [
      { sp: 'A', id: 'Maaf, di sekitar sini ada kantor pos?', t: ['すみません', '、', 'この', 'あたり', 'に', '郵便局', 'は', 'あります', 'か', '。'] },
      { sp: 'B', id: ['Kantor pos, ya?', 'Lurus saja jalan ini, lalu belok kanan di tikungan kedua.'], t: ['郵便局', 'です', 'か', '。', 'この', '道', 'を', 'まっすぐ', '行って', '、', '二つ目', 'の', '角', 'を', '右', 'に', '曲がって', 'ください', '。'] },
      { sp: 'A', id: ['Tikungan kedua, ya?', 'Ada penandanya?'], t: ['二つ目', 'の', '角', 'です', 'ね', '。', '目印', 'は', 'あります', 'か', '。'] },
      { sp: 'B', id: ['Karena simpangannya besar, ada lampu lalu lintasnya.', 'Kalau sudah belok, akan terlihat di sebelah kiri.'], t: ['大きい', '交差点', 'な', 'ので', '、', '信号', 'が', 'あります', '。', '曲がる', 'と', '、', '左側', 'に', '見えて', 'き', 'ます', 'よ', '。'] },
      { sp: 'A', id: 'Kalau jalan kaki, kira-kira berapa lama?', t: ['歩いて', 'どの', 'くらい', 'です', 'か', '。'] },
      { sp: 'B', id: ['Tidak sampai lima menit.', 'Tapi karena jalannya menanjak, mungkin agak panas.'], t: ['五分', 'も', 'かかり', 'ません', '。', '坂', 'を', '上る', 'ので', '、', '少し', '暑い', 'かもしれません', 'が', '。'] },
      { sp: 'A', id: ['Baiklah.', 'Terima kasih.'], t: ['わかりました', '。', 'ありがとう', 'ございます', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Tadi malam, saya berjalan di kawasan perumahan mencari rumah teman, tetapi rumah-rumahnya sama bentuk dan berderet, sampai saya tidak tahu lagi saya ada di mana.', t: ['昨日', 'の', '夜', '、', '友達', 'の', '家', 'を', '探して', '住宅街', 'を', '歩いて', 'いた', 'の', 'です', 'が', '、', '同じ', '形', 'の', '家', 'が', '続いて', '、', '自分', 'が', 'どこ', 'に', 'いる', 'の', 'か', '分からなくなりました', '。'] },
      { id: 'Padahal alamatnya sudah saya tahu, tetapi karena nomor rumahnya ditentukan oleh urutan bangunan, bukan oleh jalannya, melihat peta pun saya tidak paham.', t: ['住所', 'は', '分かって', 'いた', 'のに', '、', '番地', 'が', '道', 'で', 'は', 'なく', '建物', 'の', '並び順', 'で', '決まって', 'いる', 'ので', '、', '地図', 'を', '見', 'て', 'も', '分かり', 'ません', 'でした', '。'] },
      { id: 'Karena baterai ponsel saya habis, terpaksa saya bertanya kepada orang yang lewat.', t: ['スマホ', 'の', '充電', 'が', '切れて', 'いた', 'ので', '、', '仕方なく', '通りがかり', 'の', '人', 'に', '聞き', 'ました', '。'] },
      { id: 'Orang itu baik sekali, ikut berjalan bersama saya sampai sebagian jalan, dan memberi tahu bahwa rumahnya ada di tikungan ini, bangunan ketiga.', t: ['親切な', '人', 'が', '、', '途中', 'まで', '一緒に', '歩いて', 'くれて', '、', 'この', '曲がり角', 'の', '三軒目', 'です', 'と', '教えて', 'くれました', '。'] },
      { id: 'Saya putuskan, lain kali kalau mengunjungi rumah orang, akan berangkat supaya tiba sebelum gelap.', t: ['人', 'の', '家', 'を', '訪ねる', 'とき', 'は', '、', '暗く', 'なる', '前', 'に', '着く', 'ように', 'しよう', 'と', '決め', 'ました', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Saya keluar dari stasiun jam enam, dan karena masih terang, saya putuskan berjalan kaki.', t: ['駅', 'を', '出た', 'の', 'は', '六時', 'で', '、', 'まだ', '明るかった', 'ので', '、', '歩いて', '行く', 'こと', 'に', 'しました', '。'] },
      { id: 'Setelah beberapa lama menyusuri jalan besar, di tengah ada taman, dan di situ jalannya bercabang dua.', t: ['大通り', 'を', 'しばらく', '歩いたら', '、', '途中', 'に', '公園', 'が', 'あって', '、', 'そこ', 'で', '道', 'が', '二つ', 'に', '分かれ', 'ました', '。'] },
      { id: 'Yang dekat jalannya sempit, yang jauh jalannya lebar.', t: ['近い', '方', 'は', '細い', '道', 'で', '、', '遠い', '方', 'は', '広い', '通り', 'でした', '。'] },
      { id: 'Karena mulai gelap, saya memilih jalan lebar yang ada lampu jalannya.', t: ['暗く', 'なり', '始めて', 'いた', 'ので', '、', '街灯', 'の', 'ある', '広い', '通り', 'を', '選び', 'ました', '。'] },
      { id: 'Akibatnya saya perlu waktu sekitar lima belas menit lebih lama, tetapi saya bisa tiba tanpa tersesat.', t: ['おかげで', '十五分', 'ほど', '余分', 'に', 'かかり', 'ました', 'が', '、', '迷わ', 'ず', 'に', '着く', 'こと', 'が', 'でき', 'ました', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Pagi tadi cerah, tetapi lewat tengah hari hujan tiba-tiba turun, dan saya tidak membawa payung.', t: ['朝', 'は', '晴れて', 'いた', 'のに', '、', '昼過ぎ', 'から', '急に', '降り出して', '、', '傘', 'を', '持って', 'い', 'なかった', 'ん', 'だ', 'よ', '。'] },
      { id: 'Bahkan tepat waktu saya menyeberang simpang besar hujannya makin deras, jadi selama menunggu lampu saya basah kuyup.', t: ['しかも', '、', 'ちょうど', '大きい', '交差点', 'を', '渡って', 'いる', 'とき', 'に', '強く', 'なって', '、', '信号待ち', 'の', '間', 'ずぶ濡れ', 'に', 'なった', '。'] },
      { id: 'Saya masuk ke toko di dekat situ untuk berteduh, tetapi merasa tidak enak kalau tidak membeli apa-apa, akhirnya saya membeli barang yang tidak saya butuhkan.', t: ['近く', 'の', '店', 'に', '入って', '雨宿り', 'した', 'ん', 'だけど', '、', '買い物', 'を', 'し', 'ない', 'と', '悪い', '気', 'が', 'して', '、', '結局', 'いらない', '物', 'を', '買って', 'しまった', '。'] },
      { id: 'Saya juga tidak punya tenaga untuk berlari pulang, jadi dengan sepatu basah saya berjalan sampai tiga puluh menit.', t: ['走って', '帰る', '元気', 'も', 'なくて', '、', '濡れた', '靴', 'の', 'まま', '三十分', 'も', '歩いた', '。'] },
      { id: 'Bukannya mau menyalahkan siapa-siapa, tetapi ramalan cuacanya seharusnya sudah dikatakan sejak pagi.', t: ['別に', '誰か', 'を', '責め', 'たい', 'わけ', 'じゃ', 'ない', 'けど', '、', '天気予報', 'は', '朝', 'の', '時点', 'で', '言って', 'ほしかった', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Maaf, saya ingin menanyakan soal trotoar ini.', t: ['すみません', '、', 'この', '歩道', 'の', 'こと', 'で', 'お尋ね', 'したい', 'の', 'です', 'が', '。'] },
      { id: 'Sejak kemarin pagar proyeknya memakan seluruh trotoar, jadi tidak ada tempat untuk lewat.', t: ['昨日', 'から', '工事', 'の', '柵', 'が', '歩道', 'いっぱい', 'に', '出て', 'いて', '、', '通る', '場所', 'が', 'あり', 'ません', '。'] },
      { id: 'Akibatnya, orang yang mendorong kereta bayi harus turun ke jalan raya, dan saya melihat hal yang berbahaya.', t: ['その', 'せい', 'で', '、', 'ベビーカー', 'の', '人', 'が', '車道', 'に', '出', 'なければ', 'なら', 'ず', '、', '危ない', '思い', 'を', 'しました', '。'] },
      { id: 'Bisa disisakan lebar yang cukup untuk lewat, atau dipasang petunjuk jalan memutar?', t: ['通れる', '幅', 'を', '残す', 'か', '、', '迂回', 'の', '案内', 'を', '出して', 'いただけ', 'ます', 'か', '。'] },
      { id: 'Saya tahu proyeknya memang perlu, jadi akan sangat membantu kalau jalan untuk lewat tetap dijamin.', t: ['工事', 'は', '必要', 'な', 'こと', 'だ', 'と', '分かって', 'います', 'ので', '、', '通り道', 'だけ', '確保して', 'いただける', 'と', '助かり', 'ます', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Alamat di Jepang ditulis dengan urutan: pertama nama kawasannya, lalu nomor bloknya, dan setelah itu nomor bangunannya.', t: ['日本', 'の', '住所', 'は', '、', 'まず', '町', 'の', '名前', '、', '次に', '何丁目', '、', 'その', '次に', '番地', 'の', '順', 'に', '書かれて', 'います', '。'] },
      { id: 'Nomor bangunan itu bukan urutan di sepanjang jalan, melainkan urutan pemberian nama pada bloknya, jadi angkanya belum tentu berurutan.', t: ['番地', 'は', '道', 'の', '並び', 'で', 'は', 'なく', '、', 'その', '区画', 'に', '名前', 'を', '付けた', '順', 'な', 'ので', '、', '数字', 'が', '順番', 'に', '並んで', 'いる', 'と', 'は', '限り', 'ません', '。'] },
      { id: 'Karena itu, kalau berjalan hanya dengan berpegang pada nomor bangunannya, nomor yang sama terlihat seperti ada di tempat lain, dan kita tersesat.', t: ['その', 'ため', '、', '番地', 'だけ', 'を', '頼り', 'に', '歩く', 'と', '、', '同じ', '番号', 'が', '別', 'の', '場所', 'に', 'ある', 'ように', '見えて', '迷い', 'ます', '。'] },
      { id: 'Kalau ditanyakan dulu sampai nomor blok berapa di pos polisi atau di toko sebelum berjalan, kita lebih mudah sampai.', t: ['交番', 'や', '店', 'で', '何丁目', 'まで', 'を', '確認', 'して', 'から', '歩く', 'と', '、', 'たどり着き', 'やすく', 'なり', 'ます', '。'] },
      { id: 'Akhir-akhir ini nomor bangunannya tertulis di papan kecil di tanah, jadi melihat ke bawah juga membantu.', t: ['最近', 'は', '番地', 'が', '地面', 'の', '小さな', '札', 'に', '書いて', 'ある', 'ので', '、', '足元', 'を', '見る', 'の', 'も', '役に立ち', 'ます', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Halo, sekarang saya sudah keluar dari stasiun dan sudah tiba di depan simpang tempat kami janjian.', t: ['もしもし', '、', '今', '、', '駅', 'を', '出て', '、', '待ち合わせ', 'の', '交差点', 'の', '前', 'に', '着き', 'ました', '。'] },
      { id: 'Di sini orangnya banyak, jadi mungkin sebaiknya saya pindah ke tempat yang lebih mudah dilihat.', t: ['ここ', 'は', '人', 'が', '多い', 'ので', '、', '分かりやすい', '所', 'に', '移動した', '方', 'が', 'いい', 'かもしれません', '。'] },
      { id: ['Sekarang saya berdiri di depan toko di seberang.', 'Saya memakai jaket putih.'], t: ['私', 'は', '今', '、', '向かい', 'の', '店', 'の', '前', 'に', '立って', 'います', '。', '白い', '上着', 'を', '着て', 'います', '。'] },
      { id: ['Anda sekarang ada di sekitar mana?', 'Kalau jalan kaki, kira-kira berapa menit?'], t: ['そちら', 'は', 'どの', 'あたり', 'です', 'か', '。', '歩いて', '何分', 'くらい', 'でしょうか', '。'] },
      { id: ['Tidak perlu tergesa-gesa.', 'Saya menunggu di sini.'], t: ['急が', 'なくて', '大丈夫', 'です', '。', 'ここ', 'で', '待って', 'います', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Dari stasiun ke rumah ada dua jalan, yang satu pendek tetapi tanjakannya berat.', t: ['駅', 'から', '家', 'まで', '歩く', '道', 'は', '二つ', 'あって', '、', '一つ', 'は', '短い', 'けど', '坂', 'が', 'きつい', '道', 'です', '。'] },
      { id: 'Yang satu lagi memutar, tetapi hampir rata dan di tengahnya ada taman.', t: ['もう', '一つ', 'は', '遠回り', 'だけど', '、', 'ほぼ', '平ら', 'で', '、', '途中', 'に', '公園', 'が', 'あります', '。'] },
      { id: 'Kalau bawaan saya banyak, jalan yang menanjak itu berat, jadi saya memilih yang rata walau harus memutar.', t: ['荷物', 'が', '多い', '日', 'は', '坂', 'の', '道', 'は', 'つらい', 'ので', '、', '遠回り', 'で', 'も', '平ら', 'な', '方', 'を', '選び', 'ます', '。'] },
      { id: 'Sebaliknya, kalau hujan, jalan lewat taman jadi becek, jadi jalan yang menanjak lebih baik.', t: ['逆に', '、', '雨', 'の', '日', 'は', '公園', 'の', '道', 'が', 'ぬかるむ', 'ので', '、', '坂', 'の', '道', 'の', '方', 'が', 'まし', 'です', '。'] },
      { id: 'Jadi, saya rasa paling baik memutuskan berdasarkan bawaan hari itu dan cuacanya.', t: ['だから', '、', 'その', '日', 'の', '荷物', 'と', '天気', 'で', '決める', 'の', 'が', '一番', 'いい', 'と', '思い', 'ます', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Kalau pulang malam, sebaiknya jangan lewat di dalam taman.', t: ['夜', 'に', '帰る', 'なら', '、', '公園', 'の', '中', 'を', '通ら', 'ない', '方', 'が', 'いい', 'よ', '。'] },
      { id: 'Siang memang jalan pintas, tetapi karena lampu jalannya sedikit, kaki kita sulit melihat.', t: ['昼', 'は', '近道', 'だけど', '、', '街灯', 'が', '少ない', 'から', '、', '足元', 'が', '見え', 'にくい', 'ん', 'だ', '。'] },
      { id: 'Selain itu, pohonnya banyak, jadi orang yang datang dari arah berlawanan baru terlihat di saat terakhir.', t: ['しかも', '、', '木', 'が', '多くて', '、', '向こう', 'から', '来る', '人', 'が', 'ぎりぎり', 'まで', '見え', 'ない', '。'] },
      { id: 'Walau memutar, kalau lewat jalan besar ada cahaya toko, jadi lebih aman.', t: ['遠回り', 'で', 'も', '、', '大通り', 'を', '通れ', 'ば', '、', '店', 'の', '明かり', 'が', 'ある', 'から', '安心', 'だ', 'よ', '。'] },
      { id: 'Kalau memang harus lewat taman, sebaiknya nyalakan lampu ponsel dan jangan mendengarkan musik.', t: ['どうしても', '公園', 'を', '通る', 'なら', '、', 'スマホ', 'の', '明かり', 'を', 'つけて', '、', '音楽', 'は', '聞か', 'ない', '方', 'が', 'いい', '。'] },
    ]
  },
  {
    ...
    blocks: [
      ...
      { id: 'Saya ingin berfoto berdua dengan teman di depan monumen ini, bisa Anda yang menekan tombolnya?', t: ['この', '記念碑', 'の', '前', 'で', '、', '友達', 'と', '二人', 'で', '写真', 'を', '撮り', 'たい', 'の', 'です', 'が', '、', 'シャッター', 'を', '押して', 'いただけ', 'ません', 'か', '。'] },
      { id: ['Cukup menekannya saja.', 'Tolong supaya kami berdua masuk di tengah.'], t: ['押す', 'だけ', 'で', '大丈夫', 'です', '。', '真ん中', 'に', '二人', 'が', '入る', 'ように', 'お願い', 'します', '。'] },
      { id: 'Akan lebih menyenangkan kalau tulisan di monumennya juga masuk.', t: ['記念碑', 'の', '文字', 'も', '入る', 'と', 'うれしい', 'です', '。'] },
      { id: 'Kalau Anda sedang buru-buru, tentu saja boleh menolak.', t: ['もし', 'お急ぎ', 'でしたら', '、', 'もちろん', '断って', 'いただいて', '構い', 'ません', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Minggu lalu, waktu saya berjalan di jalan depan rumah, saya ditegur oleh orang tua yang datang dari arah depan.', t: ['先週', '、', '家', 'の', '前', 'の', '道', 'を', '歩いて', 'いたら', '、', '前', 'から', '来た', 'お年寄り', 'に', '声', 'を', 'かけられ', 'ました', '。'] },
      { id: 'Setelah berbicara, katanya orang itu dulu tinggal di sekitar sini, dan sekarang bangunannya sudah berubah semua.', t: ['話して', 'みる', 'と', '、', 'その', '人', 'は', '昔', 'この', '辺り', 'に', '住んで', 'いた', 'そう', 'で', '、', '今', 'は', '建物', 'が', '変わって', 'しまった', 'と', '言って', 'いました', '。'] },
      { id: 'Waktu saya menyebut nama kakek saya, ternyata orang itu mengenalnya, dan tiba-tiba saja dia mulai bercerita tentang masa lalu.', t: ['私', 'が', '祖父', 'の', '名前', 'を', '出したら', '、', 'なんと', '知り合い', 'だった', 'らしく', '、', 'その', '人', 'は', '急に', '昔', 'の', '話', 'を', '始め', 'ました', '。'] },
      { id: 'Obrolan berdiri itu sampai lebih dari dua puluh menit, tetapi setelah mendengar bahwa jalan itu dulu sungai, cara saya melihatnya berubah.', t: ['立ち話', 'は', '二十分', '以上', 'に', 'なり', 'ました', 'が', '、', 'あの', '道', 'が', '昔', 'は', '川', 'だった', 'と', '聞いて', '、', '見る', '目', 'が', '変わり', 'ました', '。'] },
      { id: 'Sejak itu, kalau berjalan di jalan yang sama, saya sedikit melihat wajah orang yang datang dari depan.', t: ['あれ', 'から', '、', '同じ', '道', 'を', '歩く', 'とき', 'は', '、', '前', 'から', '来る', '人', 'の', '顔', 'を', '少し', '見る', 'ように', 'して', 'います', '。'] },
    ]
  },
  {
    ...
    blocks: [
      { id: 'Kepada para pengguna jalan, ada pengumuman.', t: ['ご通行', 'の', '皆様', 'に', 'お知らせ', 'いたし', 'ます', '。'] },
      { id: 'Hari ini dan besok, dua hari, jalan ini karena persiapan festival tidak bisa dilewati kendaraan maupun orang, dari pagi sampai malam.', t: ['本日', 'と', '明日', 'の', '二日間', '、', 'この', '通り', 'は', '祭り', 'の', '準備', 'の', 'ため', '、', '朝', 'から', '夜', 'まで', '車', 'も', '人', 'も', '通れ', 'ません', '。'] },
      { id: 'Yang datang dengan berjalan kaki, silakan memutar lewat jalan sempit di sisi stasiun.', t: ['歩いて', 'お越し', 'の', '方', 'は', '、', '駅側', 'の', '細い', '道', 'を', '回って', 'ください', '。'] },
      { id: 'Jalan memutarnya perlu waktu sekitar sepuluh menit, jadi silakan berangkat dengan waktu yang cukup.', t: ['回り道', 'は', '十分', 'ほど', 'かかり', 'ます', 'ので', '、', 'お時間', 'に', '余裕', 'を', '持って', 'お出かけ', 'ください', '。'] },
      { id: 'Selain itu, setelah jam enam sore akan ada lapak dagang, sehingga tidak bisa dilewati.', t: ['なお', '、', '夕方', '六時', '以降', 'は', '露店', 'が', '出', 'ます', 'ので', '、', '通り抜け', 'は', 'でき', 'ません', '。'] },
    ]
  },
]);
