...
**Angka yang dipakai, diukur dari bank yang ada sekarang (587 kalimat panjang).** Inilah dasarnya,
...
|---|---|
| Relasi dihitung sebagai **pasangan** (`ので+し`) | `ので` muncul bersama banyak pasangan berbeda, jadi tidak ada satu pasangan yang terlihat besar, padahal `ので` sendiri memegang **230 dari 587** kalimat |
...
Sesudah dibetulkan: `ので` **230** kalimat (39,2%), `から` **167** (28,4%), `し` **73** (12,4%).
